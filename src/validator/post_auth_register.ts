...
export default [
    ...
    check('date_sign').matches("\\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|[3][01]) (0[0-9]|1[0-9]|2[123]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9])"),
    check('date_update').not().isEmpty().withMessage("Value Can't Be Empty"),
    check('date_update').matches("\\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|[3][01]) (0[0-9]|1[0-9]|2[123]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9])"),
    check('date_online').not().isEmpty().withMessage("Value Can't Be Empty"),
    check('date_online').matches("\\d{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|[3][01]) (0[0-9]|1[0-9]|2[123]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9])"),
